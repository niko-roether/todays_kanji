...
final _darkColorScheme = ColorScheme(
  background: Color.fromRGBO(20, 20, 25, 1),
  ...
  onSurface: Color.fromRGBO(220, 220, 220, 1),
  primary: Color.fromRGBO(40, 40, 60, 1),
  ...
  surface: Color.fromRGBO(40, 40, 60, 1),
);
...
).copyWith(splashColor: _darkColorScheme.onSurface);
